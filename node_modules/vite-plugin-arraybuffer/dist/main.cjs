...
var VIRTUAL_ID = "virtual:decode-64";
    ...
    load: {
      ...
      async handler(id) {
        ...
        if (id.endsWith("?arraybuffer")) {
          ...
          const bytes = new Uint8Array(await import_fs.promises.readFile(cleanId));
          return {
        ...
        if (id.endsWith("?arraybuffer&base64")) {
          this.addWatchFile(cleanId);
          const buffer = await import_fs.promises.readFile(cleanId);
