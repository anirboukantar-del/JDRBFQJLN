...
export interface Weapon {
    ...
    // --- NOUVEAUTÉ : Multiplicateurs globaux ---
...
export const weaponsDB: Record<string, Weapon> = {
    ...
    massue_sauvage: {
        ...
        fixedPpPenalty: 0.95,
        atkMultiplier: 0.20,   // +20% ATK Totale
        defMultiplier: -0.25   // -25% DEF Totale
    },
    poings_lave: {
        id: 'poings_lave', name: 'Poings Lave', description: 'Brûlent tout ce qu\'ils touchent.',
        atkBoost: 12, element: 'feu', elementPercent: 1.0
    },
    lance_tenebre: {
        id: 'lance_tenebre', name: 'Lance Ténèbre', description: 'Haut risque d\'empoisonnement (+30%).',
        atkBoost: 20, element: 'poison', elementPercent: 0.6,
        poisonChanceBonus: 0.30
    },
    tournesol: {
        id: 'tournesol', name: 'Tournesol', description: 'Amplifie les soins de 30%.',
        atkBoost: 5, element: 'plante', elementPercent: 1.0,
        healBonus: 0.30
    },
    canon_magma: {
        id: 'canon_magma', name: 'Canon Magma', description: 'Attaques Spé +60% Dégâts, coût en PP +80%.',
        atkBoost: 25, element: 'feu', elementPercent: 0.7,
        spAtkBonus: 0.60, 
        spCostPenalty: 0.80 // Passé à 80% !
    }
};