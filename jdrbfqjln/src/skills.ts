...
export const skillsDB: Record<string, Skill> = {
    ...
    boule_de_feu: { id: "boule_de_feu", name: "Boule de Feu", description: "Lance une boule de feu brûlante.", pwr: 2.0, ppCost: 10, modifiers: [], element: 'feu', level: 1, category: 'attaque', targetType: 'single', isAdvanced: true },
    soin_leger: { id: "soin_leger", name: "Soin Léger", description: "Restaure quelques Points de Vie.", pwr: -1.0, ppCost: 8, modifiers: [], element: 'normal', level: 1, category: 'soutien', targetType: 'self', isAdvanced: true },
    soin_general: { id: "soin_general", name: "Soin Général", description: "Soigne tous les alliés.", pwr: -0.8, ppCost: 15, modifiers: [], element: 'normal', level: 1, category: 'soutien', targetType: 'all_allies', isAdvanced: true },
    ...
    tsunami: { id: "tsunami", name: "Tsunami", description: "Frappe tous les ennemis. Peut embourber.", pwr: 1.8, ppCost: 25, modifiers: [], element: 'eau', level: 1, category: 'attaque', targetType: 'all_enemies', isAdvanced: true },
    volcan: { id: "volcan", name: "Volcan", description: "Frappe tous les ennemis. Peut brûler.", pwr: 1.8, ppCost: 25, modifiers: [], element: 'feu', level: 1, category: 'attaque', targetType: 'all_enemies', isAdvanced: true },
